...
with st.sidebar:
    k = st.number_input("k (number of similar snippets from document taken)", 1, 10, 3)
...
# Accept user input
if prompt := st.chat_input("Ask me something you want to know about in this document!"):
    ...
    with st.chat_message("assistant"):
        ...
        st.write("The context pieces are: "+context)
